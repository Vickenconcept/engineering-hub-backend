...
class CreateProjectRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'location_country' => ['required_without:location', 'string', 'max:100'],
            'location_state' => ['required_without:location', 'string', 'max:100'],
            'location_address' => ['required_without:location', 'string', 'max:255'],
    ...
    public function messages(): array
    {
        return [
            ...
            'location.required_without' => 'Project location is required.',
            'location.max' => 'Location cannot exceed 255 characters.',
            'location_country.required_without' => 'Country is required.',
            'location_state.required_without' => 'State is required.',
            'location_address.required_without' => 'Address is required.',
